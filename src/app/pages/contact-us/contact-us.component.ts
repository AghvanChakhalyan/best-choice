...
export class ContactUsComponent implements OnInit {
  ...
  constructor() {
    this.contactUsForm = new FormGroup({
      'name': new FormControl('', [Validators.required, Validators.pattern(ValidatorHelper.nameRegEx),
        Validators.minLength(2), Validators.maxLength(12)]),
      'surname': new FormControl('', [Validators.required, Validators.pattern(ValidatorHelper.nameRegEx),
        Validators.minLength(2), Validators.maxLength(12)]),
